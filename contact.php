...
if(trim($first_name) == '') {
	...
	echo '<div class="error_message">Atención! Por favor, introduce una dirección de correo electrónico válida.</div>';
	exit();
} else if(!isEmail($email)) {
	echo '<div class="error_message">Atención! Has introducido una dirección de correo electrónico no válida, inténtalo de nuevo.</div>';
	exit();
}

if(trim($comments) == '') {
	echo '<div class="error_message">Atención! Por favor ingrese su mensaje.</div>';
	exit();
}
